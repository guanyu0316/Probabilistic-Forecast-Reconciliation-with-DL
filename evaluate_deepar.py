...
parser.add_argument('--model-name', default='param_search/lam_0.002-lstm_dropout_0.4', help='Directory containing params.json')
...
def plot_eight_windows(plot_dir,
    ...
    mu_pred_df.to_csv(f'result/deepar/mu_pred.csv')
    std_pred_df.to_csv(f'result/deepar/std_pred.csv')
